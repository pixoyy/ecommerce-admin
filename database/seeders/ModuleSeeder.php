...
class ModuleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Module::insert([
            ['module_group_id' => null, 'name' => 'Dashboard', 'route' => 'admin.dashboard', 'order' => 1, 'icon' => 'grid-1x2-fill', 'is_shown' => 1],
            ...
            ['module_group_id' => 6, 'name' => 'Produk', 'route' => 'admin.products', 'order' => 1, 'icon' => 'box-seam', 'is_shown' => 1],
            ['module_group_id' => 6, 'name' => 'Varian Produk', 'route' => 'admin.product-variants', 'order' => 2, 'icon' => 'boxes', 'is_shown' => 1],
            ...
            ['module_group_id' => 9, 'name' => 'Pesanan', 'route' => 'admin.orders', 'order' => 1, 'icon' => 'cart-check', 'is_shown' => 1],
